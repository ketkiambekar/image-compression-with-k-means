...
We have a small version (128, 128, 3) and a large version (512, 512, 3) of the same image. The said images are available on this github page and need to be loaded to files section on the left pane in google colab before executing the K_Means_for_Image_Compression.ipynb notebook.
